...
// node_modules/@bedrock-layout/center/lib/index.m.js
init_react();

// node_modules/@bedrock-layout/spacing-constants/lib/index.m.js
init_react();
...
var getSpacingValue = (theme, spacingKey) => {
  var _a, _b;
...
var validateGutter = gutterValidator;
var getSizeValue = (theme, sizeKey) => {
  var _a;
...
var Center = styled_components_browser_esm_default.div.attrs(({ centerChildren, centerText, maxWidth, theme, style }) => {
  var _a;
  const centerProps = [
...
PadBox.propTypes = {
  padding: PropTypes2.oneOfType([
    validateGutter,
    PropTypes2.objectOf(validateGutter),
    PropTypes2.arrayOf(validateGutter)
  ]).isRequired
};
...
var propTypes3 = { exports: {} };
var ReactPropTypesSecret$13 = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";
var ReactPropTypesSecret_13 = ReactPropTypesSecret$13;
var ReactPropTypesSecret3 = ReactPropTypesSecret_13;
function emptyFunction3() {
}
function emptyFunctionWithReset3() {
}
emptyFunctionWithReset3.resetWarningCache = emptyFunction3;
var factoryWithThrowingShims3 = function() {
  function shim(props, propName, componentName, location, propFullName, secret) {
  ...
  var ReactPropTypes = {
    ...
    shape: getShim,
    exact: getShim,
    checkPropTypes: emptyFunctionWithReset3,
    resetWarningCache: emptyFunction3
  };
  ReactPropTypes.PropTypes = ReactPropTypes;
  return ReactPropTypes;
};
{
  propTypes3.exports = factoryWithThrowingShims3();
}
var PropTypes3 = propTypes3.exports;
var Reel = styled_components_browser_esm_default.div.attrs((props) => {
  ...
  return {
    ...
    style: __spreadProps3(__spreadValues3({}, props.style), { "--gutter": maybeGutter })
  };
})`
  box-sizing: border-box;
  > * {
...
Reel.propTypes = {
  snapType: PropTypes3.oneOf(["none", "proximity", "mandatory"]),
  gutter: validateGutter
};

// node_modules/@bedrock-layout/stack/lib/index.m.js
init_react();
...
var Stack = styled_components_browser_esm_default.div.attrs(({ gutter, theme, style }) => {
  const maybeGutter = getSafeGutter(theme, gutter);
  return {
    "data-bedrock-stack": "",
    style: __spreadProps4(__spreadValues4({}, style), { "--gutter": maybeGutter })
  };
})`
  @property --gutter {
    syntax: "<length-percentage>";
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-NJCC5VS2.js.map
