...
// node_modules/@bedrock-layout/grid/lib/index.m.js
init_react();
...
var Grid = styled_components_browser_esm_default.div.attrs(({ style, theme, minItemWidth, gutter }) => {
  var _a;
  const safeMinItemWidth = (_a = getSizeValue(theme, minItemWidth)) != null ? _a : minItemWidth;
  const safeGutter = getSafeGutter(theme, gutter);
  return {
    "data-bedrock-grid": "",
    style: __spreadProps3(__spreadValues3({}, style), {
      "--gutter": safeGutter,
...
function validateMinItemWidth({ minItemWidth }, propName) {
  if (minItemWidth === void 0)
    return void 0;
  const isValid = typeof minItemWidth === "number" || checkIsCSSLength(minItemWidth) || Object.keys(sizes).includes(minItemWidth);
  if (!isValid) {
    console.error(`${propName} needs to be an number, CSSLength or SizesOptions`);
  }
  return void 0;
...
Grid.propTypes = {
  ...
  minItemWidth: validateMinItemWidth
};
...
var Reel = styled_components_browser_esm_default.div.attrs((props) => {
  ...
  return {
    ...
    style: __spreadProps4(__spreadValues4({}, props.style), { "--gutter": maybeGutter })
  };
})`
  box-sizing: border-box;
  > * {
...
function Index() {
  return /* @__PURE__ */ React.createElement("div", {
    ...
    maxWidth: "90%"
  }, /* @__PURE__ */ React.createElement("h1", null, "Where to have lunch?"), /* @__PURE__ */ React.createElement(Grid, {
    gutter: "md",
    minItemWidth: "25rem"
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-AZOUWV62.js.map
