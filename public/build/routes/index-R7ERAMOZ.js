...
var Reel = styled_components_browser_esm_default.div.attrs((props) => {
  ...
  return {
    ...
    style: __spreadProps2(__spreadValues2({}, props.style), { "--gutter": maybeGutter })
  };
})`
...
var Stack = styled_components_browser_esm_default.div.attrs(({ gutter, theme, style }) => {
  ...
  return {
    "data-bedrock-stack": "",
    style: __spreadProps3(__spreadValues3({}, style), { "--gutter": maybeGutter })
  };
})`
  @property --gutter {
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-R7ERAMOZ.js.map
